...
export const DesktopProfileMenu = ({ isOpen, links, toggleMenu, closeMenu }) => (
  <div className="relative">
    {/* Menú desplegable */}
    <div
      className={`absolute right-0 mt-2 w-48 bg-black bg-opacity-90 rounded-lg shadow-lg transition-all duration-300 ${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible'
        }`}
    >
