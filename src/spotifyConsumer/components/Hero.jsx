...
export const Hero = () => {
  ...
  const onSetTraks = async (token, href) => {
    setTracks([]);
    try {
      const tracksPromise = setSpotifyTracksPlaylist(token, href);
          ...
          <div className="space-y-10">
              ...
              <section className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    >
                      {filteredOwnPlaylists.length}{" "}
                      {filteredOwnPlaylists.length === 1
                        ? "playlist"
                        : "playlists"}
                    </span>
                  </div>
                  ...
                  {filteredOwnPlaylists.length > 3 && (
                    <button
                      onClick={() =>
                        setShowAllOwnPlaylists(!showAllOwnPlaylists)
                      }
                ...
                {displayedOwnPlaylists.length > 0 ? (
                  ...
                  >
                    {search
                      ? "No se encontraron playlists propias con ese nombre"
                      : "No tienes playlists propias"}
                  </div>
                )}
              </section>
            )}
              ...
              <section className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    >
                      {filteredFollowedPlaylists.length}{" "}
                      {filteredFollowedPlaylists.length === 1
                        ? "playlist"
                        : "playlists"}
                    </span>
                  </div>
                  ...
                  {filteredFollowedPlaylists.length > 3 && (
                    <button
                      onClick={() =>
                        setShowAllFollowedPlaylists(!showAllFollowedPlaylists)
                      }
                      className={`text-sm px-3 py-1 rounded-full flex items-center ${
                        isDarkMode
            ...
            <section>
              <div className="flex items-center mb-4">
                ...
                >
                  {filteredSharedPlaylists.length}{" "}
                  {filteredSharedPlaylists.length === 1
                    ? "playlist"
                    : "playlists"}
                </span>
              </div>
              ...
              {loading ? (
                ...
                >
                  {search
                    ? "No se encontraron playlists recomendadas con ese nombre"
            ...
            {selectedPlaylist ? (
              <div className="space-y-4">
                <div className="relative">
                  ...
                  />
                  <div
                    className={`absolute -bottom-3 left-4 px-3 py-1 rounded-full text-sm font-bold ${
                      isDarkMode
                        ? userOwnPlaylists?.some(
                            (own) => own.id === selectedPlaylist.id
                          )
                          ? "bg-red-600 text-white"
                          : userFollowedPlaylists?.some(
                              (followed) => followed.id === selectedPlaylist.id
                            )
