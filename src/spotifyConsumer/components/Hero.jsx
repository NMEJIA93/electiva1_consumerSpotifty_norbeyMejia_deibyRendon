  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-black text-white' : 'bg-gray-100 text-gray-800'} transition-colors duration-300`}>
      ...
      <div className="flex">
        ...
        <div className="w-[70%] p-6 flex flex-col space-y-8 overflow-auto">
          ...
          <div className="sticky top-0 z-10 bg-inherit pb-4">
            <input
              ...
              className={`p-3 rounded-lg w-full ${isDarkMode
              ...
              <section className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <span className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${isDarkMode ? 'bg-gray-700 text-red-300' : 'bg-blue-100 text-blue-800'
                      }`}>
                  ...
                  {filteredOwnPlaylists.length > 3 && (
                    <button
                      ...
                      className={`text-sm px-3 py-1 rounded-full flex items-center ${isDarkMode
                ...
                {displayedOwnPlaylists.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {displayedOwnPlaylists.map((playlist) => (
                      <div
                        key={playlist.id}
                        className={`rounded-lg overflow-hidden cursor-pointer transition-all duration-300 hover:scale-[1.02] ${isDarkMode
                      ...
                      >
                        <div className="relative">
                          {(
                            <img
                              src={playlist.images && playlist.images[0] && playlist.images[0].url ? playlist.images[0].url : imageMock}
                              alt={playlist.name}
                          ...
                          <div className={`absolute bottom-0 left-0 right-0 p-2 ${isDarkMode ? 'bg-gradient-to-t from-gray-900 to-transparent' : 'bg-gradient-to-t from-white to-transparent'
                            }`}>
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex justify-between items-center mt-3 text-xs">
                            <span className={`px-2 py-1 rounded ${isDarkMode ? 'bg-gray-700 text-gray-300' : 'bg-blue-100 text-blue-800'
                              }`}>
                  ...
                  <div className={`p-8 rounded-lg text-center ${isDarkMode ? 'bg-gray-800 text-gray-400' : 'bg-gray-100 text-gray-500'
                    }`}>
              ...
              <section className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <span className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${isDarkMode ? 'bg-gray-700 text-purple-300' : 'bg-purple-100 text-purple-800'
                      }`}>
                  ...
                  {displayedFollowedPlaylists.map((playlist) => (
                    ...
                    >
                      <div className="relative">
                        ...
                        <button
                          className={`absolute top-2 right-2 w-8 h-8 rounded-full flex items-center justify-center ${isDarkMode
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex justify-between items-center mt-3 text-xs">
                          <span className={`px-2 py-1 rounded ${isDarkMode ? 'bg-gray-700 text-gray-300' : 'bg-purple-100 text-purple-800'
                            }`}>
                            {playlist.tracks.total} canciones
                          </span>
                          <span className={isDarkMode ? 'text-gray-400' : 'text-gray-500'}>
        ...
        <div className={`w-[30%] ${isDarkMode ? 'bg-gray-900 border-l border-gray-700' : 'bg-gray-50 border-l border-gray-200'
          } fixed right-0 top-16 bottom-0 transition-colors duration-300`}>
          <div
            className={`h-full p-6 ${scrollEnabled ? "overflow-y-auto" : "overflow-hidden"
              }`}
            ...
            {selectedPlaylist ? (
              <div className="space-y-4">
                <div className="relative">
                  ...
                  />
                  <div className={`absolute -bottom-3 left-4 px-3 py-1 rounded-full text-sm font-bold ${isDarkMode
                ...
                <div className="mt-6">
                  <h3 className={`text-lg font-semibold mb-3 pb-2 border-b ${isDarkMode ? 'border-gray-700 text-red-500' : 'border-gray-200 text-blue-600'
                    }`}>
                    Canciones
                  </h3>
